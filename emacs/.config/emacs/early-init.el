...
(defvar meain/font-list '(;; name size line-spacing weight
                          ...
                          ("M+ 1m" . '(11 nil 'regular))
                          ("Mirage" . '(10 .1 'regular))
                          ("Monaco for Powerline" . '(11 .1 'regular))
                          ...
                          ("NanumGothicCoding" . '(13 .1 'regular))
                          ("NK57 Monospace" . '(11 .2 'regular))
                          ("Operator Mono" . '(12 .1 'regular))
                          ("Operator Mono Light" . '(12 .1 'regular))
...
(defvar meain/font-name "DankMono")
