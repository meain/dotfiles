...
(defvar meain/font-list '(;; name size line-spacing weight
                          ...
                          ("Panic Sans" . '(10 nil 'regular))
                          ("PragmataPro" . '(10 nil 'regular))
                          ("ProFont for Powerline" . '(13 .1 'regular))
                          ("PT Mono" . '(11 .1 'regular))
                          ("Quinze" . '(13 nil 'regular))
                          ("Rec Mono Casual" . '(10 nil 'regular))
                          ("Rec Mono Linear" . '(11 nil 'regular))
                          ("Rec Mono Semicasual" . '(10 nil 'regular))
...
(defvar meain/font-name "Victor Mono") ; saxMono ; Syne Mono ; Dank Mono ; Overpass Mono ; Fantasque Sans Mono
