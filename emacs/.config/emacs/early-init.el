...
(defvar meain/font-list '(;; name height line-spacing weight
                          ...
                          ("Berkeley Mono" . '(150 .1 'light))
                          ("BPMono" . '(160 .1 'regular))
                          ("Cartograph CF" . '(160 nil 'regular))
                          ("Cascadia Code" . '(150 .1 'light))
                          ("Cascadia Mono" . '(150 .1 'light))
                          ...
                          ("Go Mono" . '(160 .3 'regular))
                          ("Eirian" . '(180 nil 'regular))
                          ...
                          ("Martian Mono Condensed" . '(140 .2 'ultralight))
                          ("Martian Mono ExtraLight" . '(160 nil 'regular))
                          ("Martian Mono Light" . '(160 nil 'regular))
                          ("Martian Mono" . '(140 .2 'ultralight))
                          ("MD IO" . '(150 .2 'thin))
                          ("Menlo" . '(160 .1 'regular))
                          ("Monaco" . '(150 nil 'regular))
                          ...
                          ("MonospaceTypewriter" . '(150 .1 'regular))
