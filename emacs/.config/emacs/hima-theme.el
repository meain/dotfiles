...
(let* ((white "#FFFFFF")
       ...
       (tooltip-layer `((t (:background ,light-black :foreground ,medium-gray))))
       (tooltip-selected-layer `((t (:background ,light-blue :foreground ,dark-gray))))
  ...
  (custom-theme-set-faces 'hima
    ...
    `(company-preview ,tooltip-selected-layer)
