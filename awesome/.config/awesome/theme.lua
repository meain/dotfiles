...
theme.wallpaper = "/home/meain/Pictures/Wallpapers/current" -- wallpaper
theme.awesome_icon = theme_assets.awesome_icon(theme.menu_height, theme.bg_focus, theme.fg_focus) -- awesome icon
